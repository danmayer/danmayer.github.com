...
var graph = {
  links: [
    ...
    { source: "Application Server (Frontend)", target: "Redis Cache (Frontend)", value: "95", note: "Requests leveraging the Cache" },
    { source: "Load Balancer (with WAF)", target: "Application Server (Api)", value: "40", note: "Load Balancer target rules routed to App API Backend" },
